...
class Home extends Component {
  ...
  componentDidMount = () => {
    console.log(Globals.YOUTUBE_APIKEY)
  }
  ...
  _onVideoReady = () => {
    setTimeout(() => this.setState({ videoHeight: this.state.videoHeight + 1 }), 500)
  }
        ...
        <ScrollView
          ...
          <View style={HomeStyle.Introduction}>
            <YouTube
              ...
              videoId="uQaQVSRak4E"   // The YouTube video ID
              controls={1}
              onReady={() => this._onVideoReady()}
              style={{ alignSelf: 'stretch', height: this.state.videoHeight, borderRadius: 5, overflow: 'hidden' }}
            />
            <Text>
